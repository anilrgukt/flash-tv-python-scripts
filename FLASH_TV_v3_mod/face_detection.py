...
# face detection libs
det_path_loc = '/home/flashsys008/insightface/detection/RetinaFace'
...
class FlashFaceDetector():
	def __init__(self, detector_threshold=0.15, detector_hw=[720,1280], output_hw=[342,608]):
		...
		gpuid=0
		self.detector = RetinaFace('/home/flashsys008/insightface/detection/RetinaFace/model/retina', 0, gpuid, 'net3', vote=False)
		self.det_path_loc = '/home/flashsys008/insightface/detection/RetinaFace'
